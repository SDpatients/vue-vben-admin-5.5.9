...
**API端点URL**: `http://192.168.0.120:8080/api/v1/case-announcement`
**请求方法**: POST
**功能描述**: 创建新的案件公告
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/case-announcement/list`
**请求方法**: GET
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/case-announcement/{announcementId}`
**请求方法**: GET
**功能描述**: 根据公告ID获取公告详情
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/case-announcement/{announcementId}/publish`
**请求方法**: POST
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/case-announcement/{announcementId}/top`
**请求方法**: POST
**功能描述**: 置顶案件公告
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/announcement-view-record`
**请求方法**: POST
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/announcement-view-record/{recordId}`
**请求方法**: GET
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/announcement-view-record/list`
**请求方法**: GET
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/announcement-view-record/count/announcement/{announcementId}`
**请求方法**: GET
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/announcement-view-record/count/case/{caseId}`
**请求方法**: GET
...
**API端点URL**: `http://192.168.0.120:8080/api/v1/announcement-view-record/count/viewer/{viewerId}`
**请求方法**: GET
