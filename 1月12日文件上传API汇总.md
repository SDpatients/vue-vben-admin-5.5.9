...
axios.post('http://192.168.0.151:8080/api/v1/file/upload', formData, {
  headers: {
    'Authorization': 'Bearer ' + token,
    'Content-Type': 'multipart/form-data'
  }
...
fetch('http://192.168.0.151:8080/api/v1/file/upload', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer ' + token
  },
...
window.location.href = `http://192.168.0.151:8080/api/v1/file/download/${fileId}?token=${token}`;
```
...
fetch(`http://192.168.0.151:8080/api/v1/file/download/${fileId}`, {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer ' + token
  }
...
axios.get(`http://192.168.0.151:8080/api/v1/file/${fileId}`, {
  headers: {
    'Authorization': 'Bearer ' + token
  }
})
...
axios.get('http://192.168.0.151:8080/api/v1/file/list', {
  headers: {
    'Authorization': 'Bearer ' + token
  },
  params: params
...
axios.delete(`http://192.168.0.151:8080/api/v1/file/${fileId}`, {
  headers: {
    'Authorization': 'Bearer ' + token
  }
})
...
axios.delete('http://192.168.0.151:8080/api/v1/file/batch', {
  headers: {
    'Authorization': 'Bearer ' + token,
    'Content-Type': 'application/json'
  },
...
axios.put(`http://192.168.0.151:8080/api/v1/file/${fileId}/rename`, formData, {
  headers: {
    'Authorization': 'Bearer ' + token
  }
})
...
axios.put(`http://192.168.0.151:8080/api/v1/file/${fileId}/status`, formData, {
  headers: {
    'Authorization': 'Bearer ' + token
  }
})
...
axios.put('http://192.168.0.151:8080/api/v1/file/batch/status', null, {
  headers: {
    'Authorization': 'Bearer ' + token,
    'Content-Type': 'application/json'
  },
...
axios.get('http://192.168.0.151:8080/api/v1/file/statistics', {
  headers: {
    'Authorization': 'Bearer ' + token
  },
  params: params
...
fetch(`http://192.168.0.151:8080/api/v1/file/preview/${fileId}`, {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer ' + token
  }
      ...
      try {
        ...
        for (let i = 0; i < files.length; i++) {
          ...
          const response = await axios.post(
            'http://192.168.0.151:8080/api/v1/file/upload',
            formData,
            {
              headers: {
                'Authorization': `Bearer ${token}`,
    ...
    async loadFileList() {
      try {
        ...
        const response = await axios.get(
          'http://192.168.0.151:8080/api/v1/file/list',
          {
            headers: {
              'Authorization': `Bearer ${token}`
            },
    ...
    async previewFile(fileId) {
      try {
        ...
        const response = await fetch(
          `http://192.168.0.151:8080/api/v1/file/preview/${fileId}`,
          {
            headers: {
              'Authorization': `Bearer ${token}`
            }
    ...
    async deleteFile(fileId) {
      ...
      try {
        ...
        const response = await axios.delete(
          `http://192.168.0.151:8080/api/v1/file/${fileId}`,
          {
            headers: {
              'Authorization': `Bearer ${token}`
            }
