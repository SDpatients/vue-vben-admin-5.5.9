...
window.location.href = `http://localhost:8080/api/v1/file/download/${fileId}?token=${token}`;
```
...
fetch(`http://localhost:8080/api/v1/file/download/${fileId}`, {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer ' + token
  }
...
axios.get(`http://localhost:8080/api/v1/file/${fileId}`, {
  headers: {
    'Authorization': 'Bearer ' + token
  }
})
...
axios.get('http://localhost:8080/api/v1/file/list', {
  headers: {
    'Authorization': 'Bearer ' + token
  },
  params: params
...
axios.delete(`http://localhost:8080/api/v1/file/${fileId}`, {
  headers: {
    'Authorization': 'Bearer ' + token
  }
})
...
axios.delete('http://localhost:8080/api/v1/file/batch', {
  headers: {
    'Authorization': 'Bearer ' + token,
    'Content-Type': 'application/json'
  },
...
axios.put(`http://localhost:8080/api/v1/file/${fileId}/rename`, formData, {
  headers: {
    'Authorization': 'Bearer ' + token
  }
})
...
axios.put(`http://localhost:8080/api/v1/file/${fileId}/status`, formData, {
  headers: {
    'Authorization': 'Bearer ' + token
  }
})
...
axios.put('http://localhost:8080/api/v1/file/batch/status', null, {
  headers: {
    'Authorization': 'Bearer ' + token,
    'Content-Type': 'application/json'
  },
...
axios.get('http://localhost:8080/api/v1/file/statistics', {
  headers: {
    'Authorization': 'Bearer ' + token
  },
  params: params
...
fetch(`http://localhost:8080/api/v1/file/preview/${fileId}`, {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer ' + token
  }
    ...
    async previewFile(fileId) {
      try {
        ...
        const response = await fetch(
          `http://localhost:8080/api/v1/file/preview/${fileId}`,
          {
            headers: {
              'Authorization': `Bearer ${token}`
            }
    ...
    async deleteFile(fileId) {
      ...
      try {
        ...
        const response = await axios.delete(
          `http://localhost:8080/api/v1/file/${fileId}`,
          {
            headers: {
              'Authorization': `Bearer ${token}`
            }
