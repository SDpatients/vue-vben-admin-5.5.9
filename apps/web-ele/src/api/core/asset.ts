...
export async function getPropertyListApi(params: AssetApi.PropertyQueryParams) {
  return requestClient.get<AssetApi.PropertyListResponse>(
...
export async function getPropertyDetailApi(propertyId: number) {
  return requestClient.get<{
    code: number;
    data: AssetApi.PropertyInfo;
    message: string;
  }>(`/api/v1/property/${propertyId}`);
}

export async function createPropertyApi(data: AssetApi.CreatePropertyParams) {
...
export async function getEstateListApi(params: AssetApi.EstateQueryParams) {
  return requestClient.get<AssetApi.EstateListResponse>(
    '/api/v1/real-estate/list',
    {
      params,
    },
  );
...
export async function getEstateDetailApi(estateId: number) {
  return requestClient.get<{
    code: number;
    data: AssetApi.EstateInfo;
    message: string;
  }>(`/api/v1/real-estate/${estateId}`);
}

export async function createEstateApi(data: AssetApi.CreateEstateParams) {
...
export async function getVehicleListApi(params: AssetApi.VehicleQueryParams) {
  return requestClient.get<AssetApi.VehicleListResponse>(
    '/api/v1/vehicle/list',
    {
      params,
    },
...
export async function getVehicleDetailApi(vehicleId: number) {
  return requestClient.get<{
    code: number;
    data: AssetApi.VehicleInfo;
    message: string;
  }>(`/api/v1/vehicle/${vehicleId}`);
}

export async function createVehicleApi(data: AssetApi.CreateVehicleParams) {
...
export async function getEquipmentListApi(
  ...
  return requestClient.get<AssetApi.EquipmentListResponse>(
...
export async function getEquipmentDetailApi(equipmentId: number) {
  return requestClient.get<{
    code: number;
    data: AssetApi.EquipmentInfo;
    message: string;
  }>(`/api/v1/equipment/${equipmentId}`);
}

export async function createEquipmentApi(data: AssetApi.CreateEquipmentParams) {
...
export async function getInventoryListApi(
  ...
  return requestClient.get<AssetApi.InventoryListResponse>(
...
export async function getInventoryDetailApi(inventoryId: number) {
  return requestClient.get<{
    code: number;
    data: AssetApi.InventoryInfo;
    message: string;
  }>(`/api/v1/inventory/${inventoryId}`);
}

export async function createInventoryApi(data: AssetApi.CreateInventoryParams) {
...
export async function getIntellectualPropertyDetailApi(ipId: number) {
  return requestClient.get<{
    code: number;
    data: AssetApi.IntellectualPropertyInfo;
    message: string;
