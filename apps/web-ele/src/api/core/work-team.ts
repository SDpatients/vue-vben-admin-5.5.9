...
export async function getWorkTeamListApi(
  ...
  return requestClient8085.get<WorkTeamApi.WorkTeamListResponse>('/work-team/list/details', {
    params,
  });
}
...
export async function addWorkTeamApi(data: WorkTeamApi.AddWorkTeamRequest) {
  return requestClient8085.post<WorkTeamApi.AddWorkTeamResponse>('/work-team', data);
}
...
export async function getCaseListApi(params: WorkTeamApi.CaseListQueryParams) {
  return requestClient8085.get<WorkTeamApi.CaseListResponse>('/case/simple-list', {
    params,
  });
}
