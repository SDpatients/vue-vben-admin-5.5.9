...
export namespace CaseProcessApi {
  ...
  export interface CancellationRegistrationInfo {
    ...
    sepAuser: string;
    sepAdate: string;
    sepEuser: null | string;
    sepEdate: null | string;
    zxlx: string;
    djjg: string;
    sqrq: string;
    zxrq: string;
...
> => {
  try {
    return await requestClient8085.get(
      '/api/web/getAllCancellationRegistrations',
      {
        params: { page, size },
      },
    );
...
export const getCancellationRegistrationByIdApi = async (
  sepId: number | string,
) => {
  try {
    return await requestClient8085.get(
      `/api/web/getCancellationRegistrationById`,
      {
        params: { sepId },
      },
    );
...
export const updateCancellationRegistrationApi = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateCancellationRegistration',
      data,
    );
  } catch (error) {
...
export const deleteCancellationRegistrationApi = async (
  sepId: number | string,
) => {
  try {
    return await requestClient8085.post(
      '/api/web/deleteCancellationRegistration',
      null,
      {
        params: { sepId },
      },
...
> => {
  try {
    return await requestClient8085.get(
      '/api/web/getAllTerminationLitigations',
      {
        params: { page, size },
      },
    );
...
export const getTerminationLitigationByIdApi = async (
  sepId: number | string,
) => {
  try {
    return await requestClient8085.get(
      `/api/web/getTerminationLitigationById`,
      {
        params: { sepId },
      },
    );
...
export const updateTerminationLitigationApi = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateTerminationLitigation',
      data,
    );
  } catch (error) {
...
export const deleteTerminationLitigationApi = async (
  sepId: number | string,
) => {
  try {
    return await requestClient8085.post(
      '/api/web/deleteTerminationLitigation',
      null,
      {
        params: { sepId },
      },
...
> => {
  try {
    return await requestClient8085.get(
      '/api/web/getAllAdditionalDistributions',
      {
        params: { page, size },
      },
    );
...
export const getAdditionalDistributionByIdApi = async (
  sepId: number | string,
) => {
  try {
    return await requestClient8085.get(
      `/api/web/getAdditionalDistributionById`,
      {
        params: { sepId },
      },
    );
...
export const updateAdditionalDistributionApi = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateAdditionalDistribution',
      data,
    );
  } catch (error) {
...
export const deleteAdditionalDistributionApi = async (
  sepId: number | string,
) => {
  try {
    return await requestClient8085.post(
      '/api/web/deleteAdditionalDistribution',
      null,
      {
        params: { sepId },
      },
...
> => {
  try {
    return await requestClient8085.get(
      '/api/web/getAllAccountSealManagements',
      {
        params: { page, size },
      },
    );
...
export const getAccountSealManagementPhase7ByIdApi = async (
  ...
  try {
    return await requestClient8085.get(
      `/api/web/getAccountSealManagementById`,
      {
        params: { sepId },
      },
    );
...
export const updateAccountSealManagementPhase7Api = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateAccountSealManagement',
      data,
    );
  } catch (error) {
    console.error('修改账户印章管理失败:', error);
...
export const updateDutyReportByCaseApi = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateDutyReportByCaseId',
      data,
    );
  } catch (error) {
...
> => {
  try {
    return await requestClient8085.get(
      `/api/web/getDocumentTransfersByCaseId`,
      {
        params: { sepLd, page, size },
      },
    );
...
export const updateDocumentTransferApi = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateDocumentTransfer',
      data,
    );
  } catch (error) {
...
export const deleteDocumentTransferApi = async (sepId: number | string) => {
  try {
    return await requestClient8085.post(
      '/api/web/deleteDocumentTransfer',
      null,
      {
        params: { sepId },
      },
...
> => {
  try {
    return await requestClient8085.get(
      `/api/web/getArchivingManagementsByCaseId`,
      {
        params: { sepLd, page, size },
      },
    );
...
export const updateArchivingManagementApi = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateArchivingManagement',
      data,
    );
  } catch (error) {
...
export const deleteArchivingManagementApi = async (sepId: number | string) => {
  try {
    return await requestClient8085.post(
      '/api/web/deleteArchivingManagement',
      null,
      {
        params: { sepId },
      },
...
export const updateSealDestructionByCaseApi = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateSealDestructionByCaseId',
      data,
    );
  } catch (error) {
...
export const updateAccountClosingByCaseApi = async (data: any) => {
  try {
    return await requestClient8085.post(
      '/api/web/updateAccountClosingByCaseId',
      data,
    );
  } catch (error) {
