...
export namespace ClaimReviewApi {
  ...
  /** 证据真实性枚举 */
  export type EvidenceAuthenticity = 'AUTHENTIC' | 'FAKE' | 'SUSPICIOUS';

  /** 证据关联性枚举 */
  export type EvidenceRelevance = 'IRRELEVANT' | 'RELEVANT';

  /** 证据合法性枚举 */
  export type EvidenceLegality = 'ILLEGAL' | 'LEGAL';

  /** 担保有效性枚举 */
  export type CollateralValidity = 'INVALID' | 'PARTIAL' | 'VALID';
 ...
 */
export async function createClaimReviewApi(
  data: ClaimReviewApi.CreateClaimReviewRequest,
) {
  return requestClient8085.post<ClaimReviewApi.CreateClaimReviewResponse>(
    '/claim-review',
    data,
  );
}
...
export async function getClaimReviewDetailApi(reviewId: number) {
  return requestClient8085.get<ClaimReviewApi.ClaimReviewDetailResponse>(
...
export async function getClaimReviewsByClaimIdApi(claimId: number) {
  return requestClient8085.get<ClaimReviewApi.ClaimReviewListResponse>(
 ...
 */
export async function getClaimReviewsByCaseIdApi(
  caseId: number,
  params: { pageNum?: number; pageSize?: number } = {},
) {
  return requestClient8085.get<ClaimReviewApi.ClaimReviewPageResponse>(
    `/claim-review/case/${caseId}`,
    { params },
  );
}
 ...
 */
export async function updateClaimReviewApi(
  reviewId: number,
  data: ClaimReviewApi.UpdateClaimReviewRequest,
) {
  return requestClient8085.put<ClaimReviewApi.UpdateClaimReviewResponse>(
    `/claim-review/${reviewId}`,
    data,
  );
}
...
export async function deleteClaimReviewApi(reviewId: number) {
  return requestClient8085.delete<ClaimReviewApi.DeleteClaimReviewResponse>(
    `/claim-review/${reviewId}`,
  );
}
...
export async function submitClaimReviewApi(reviewId: number) {
  return requestClient8085.post<ClaimReviewApi.CommonResponse>(
    `/claim-review/${reviewId}/submit`,
  );
}
...
export async function getReviewStatisticsApi(caseId: number) {
  return requestClient8085.get<ClaimReviewApi.ReviewStatisticsResponse>(
    `/claim-review/statistics/${caseId}`,
  );
}
