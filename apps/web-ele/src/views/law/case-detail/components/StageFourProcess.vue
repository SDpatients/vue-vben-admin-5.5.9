...
const taskConfig = [
  ...
  },
  {
    ...
    fields: [
      ...
      { label: '评估结果', prop: 'PGJG' },
      { label: '提交日期', prop: 'TJRQ', isDate: true },
      { label: '状态', prop: 'ZT', isStatus: true },
    ],
  },
  {
    key: 'propertyValuationPlan',
    name: '财产变价方案',
  ...
  },
  {
    ...
    fields: [
      ...
      { label: '选定日期', prop: 'XDRQ', isDate: true },
      { label: '委托事项', prop: 'WTSX' },
      { label: '状态', prop: 'ZT', isStatus: true },
    ],
  },
  {
    ...
    fields: [
      ...
      { label: '宣告文号', prop: 'XGWH' },
      { label: '宣告内容', prop: 'XGNR' },
      { label: '状态', prop: 'ZT', isStatus: true },
    ],
  },
  {
    key: 'propertyValuationImplementation',
    name: '财产变价实施',
    icon: 'lucide:trending-up',
    api: getAllPropertyVIMApi,
    fields: [
      { label: '变价方式', prop: 'BJFS' },
      { label: '变价日期', prop: 'BJRQ', isDate: true },
      { label: '变价结果', prop: 'BJJG' },
      { label: '成交金额', prop: 'CJJE' },
      { label: '状态', prop: 'ZT', isStatus: true },
    ],
  },
];
