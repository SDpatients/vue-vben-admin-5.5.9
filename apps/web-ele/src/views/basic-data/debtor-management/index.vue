...
const enterpriseTypeOptions = [
  ...
  { label: '中外合资企业', value: '中外合资企业' },
  { label: '中外合作企业', value: '中外合作企业' },
  { label: '个体工商户', value: '个体工商户' },
  { label: '农民专业合作社', value: '农民专业合作社' },
  { label: '一人有限责任公司', value: '一人有限责任公司' },
  { label: '国有独资公司', value: '国有独资公司' },
  { label: '全民所有制企业', value: '全民所有制企业' },
  ...
  { label: '有限责任公司(法人独资)', value: '有限责任公司(法人独资)' },
  { label: '有限责任公司(国有控股)', value: '有限责任公司(国有控股)' },
  {
    label: '有限责任公司(外商投资企业合资)',
    value: '有限责任公司(外商投资企业合资)',
  },
  { label: '有限责任公司(台港澳合资)', value: '有限责任公司(台港澳合资)' },
  {
    label: '有限责任公司(台港澳法人独资)',
    value: '有限责任公司(台港澳法人独资)',
  },
  {
    label: '有限责任公司(台港澳自然人独资)',
    value: '有限责任公司(台港澳自然人独资)',
  },
  {
    label: '有限责任公司(台港澳与外国投资者合资)',
    value: '有限责任公司(台港澳与外国投资者合资)',
  },
  { label: '有限责任公司(中外合资)', value: '有限责任公司(中外合资)' },
  { label: '有限责任公司(外国法人独资)', value: '有限责任公司(外国法人独资)' },
  {
    label: '有限责任公司(外国自然人独资)',
    value: '有限责任公司(外国自然人独资)',
  },
  {
    label: '有限责任公司(自然人投资或控股的法人独资)',
    value: '有限责任公司(自然人投资或控股的法人独资)',
  },
  { label: '股份有限公司(上市)', value: '股份有限公司(上市)' },
  { label: '股份有限公司(非上市)', value: '股份有限公司(非上市)' },
  {
    label: '股份有限公司(中外合资、未上市)',
    value: '股份有限公司(中外合资、未上市)',
  },
  {
    label: '股份有限公司(台港澳与外国投资者合资、未上市)',
    value: '股份有限公司(台港澳与外国投资者合资、未上市)',
  },
  { label: '普通合伙', value: '普通合伙' },
  { label: '有限合伙', value: '有限合伙' },
  { label: '特殊普通合伙', value: '特殊普通合伙' },
  { label: '其他', value: '其他' },
];
...
const industryOptions = [
  ...
  { label: '采矿业', value: '采矿业' },
  { label: '煤炭开采和洗选业', value: '煤炭开采和洗选业' },
  { label: '石油和天然气开采业', value: '石油和天然气开采业' },
  { label: '黑色金属矿采选业', value: '黑色金属矿采选业' },
  { label: '有色金属矿采选业', value: '有色金属矿采选业' },
  { label: '非金属矿采选业', value: '非金属矿采选业' },
  { label: '开采专业及辅助性活动', value: '开采专业及辅助性活动' },
  { label: '制造业', value: '制造业' },
  { label: '农副食品加工业', value: '农副食品加工业' },
  { label: '食品制造业', value: '食品制造业' },
  { label: '酒、饮料和精制茶制造业', value: '酒、饮料和精制茶制造业' },
  { label: '烟草制品业', value: '烟草制品业' },
  { label: '纺织业', value: '纺织业' },
  { label: '纺织服装、服饰业', value: '纺织服装、服饰业' },
  {
  ...
  { label: '家具制造业', value: '家具制造业' },
  { label: '造纸和纸制品业', value: '造纸和纸制品业' },
  { label: '印刷和记录媒介复制业', value: '印刷和记录媒介复制业' },
  {
    label: '文教、工美、体育和娱乐用品制造业',
    value: '文教、工美、体育和娱乐用品制造业',
  },
  { label: '石油、煤炭及其他燃料加工业', value: '石油、煤炭及其他燃料加工业' },
  { label: '化学原料和化学制品制造业', value: '化学原料和化学制品制造业' },
  { label: '医药制造业', value: '医药制造业' },
  { label: '化学纤维制造业', value: '化学纤维制造业' },
  { label: '橡胶和塑料制品业', value: '橡胶和塑料制品业' },
  { label: '非金属矿物制品业', value: '非金属矿物制品业' },
  { label: '黑色金属冶炼和压延加工业', value: '黑色金属冶炼和压延加工业' },
  { label: '有色金属冶炼和压延加工业', value: '有色金属冶炼和压延加工业' },
  { label: '金属制品业', value: '金属制品业' },
  { label: '通用设备制造业', value: '通用设备制造业' },
  { label: '专用设备制造业', value: '专用设备制造业' },
  { label: '汽车制造业', value: '汽车制造业' },
  {
    label: '铁路、船舶、航空航天和其他运输设备制造业',
    value: '铁路、船舶、航空航天和其他运输设备制造业',
  },
  { label: '电气机械和器材制造业', value: '电气机械和器材制造业' },
  {
    label: '计算机、通信和其他电子设备制造业',
    value: '计算机、通信和其他电子设备制造业',
  },
  { label: '仪器仪表制造业', value: '仪器仪表制造业' },
  { label: '其他制造业', value: '其他制造业' },
  { label: '废弃资源综合利用业', value: '废弃资源综合利用业' },
  { label: '金属制品、机械和设备修理业', value: '金属制品、机械和设备修理业' },
  {
    label: '电力、热力、燃气及水生产和供应业',
    value: '电力、热力、燃气及水生产和供应业',
  },
  { label: '电力、热力生产和供应业', value: '电力、热力生产和供应业' },
  { label: '燃气生产和供应业', value: '燃气生产和供应业' },
  { label: '水的生产和供应业', value: '水的生产和供应业' },
  { label: '建筑业', value: '建筑业' },
  { label: '房屋建筑业', value: '房屋建筑业' },
  { label: '土木工程建筑业', value: '土木工程建筑业' },
  { label: '建筑安装业', value: '建筑安装业' },
  { label: '建筑装饰、装修和其他建筑业', value: '建筑装饰、装修和其他建筑业' },
  { label: '批发和零售业', value: '批发和零售业' },
  { label: '批发业', value: '批发业' },
  { label: '零售业', value: '零售业' },
  { label: '交通运输、仓储和邮政业', value: '交通运输、仓储和邮政业' },
  { label: '铁路运输业', value: '铁路运输业' },
  { label: '道路运输业', value: '道路运输业' },
  { label: '水上运输业', value: '水上运输业' },
  { label: '航空运输业', value: '航空运输业' },
  { label: '管道运输业', value: '管道运输业' },
  { label: '多式联运和运输代理业', value: '多式联运和运输代理业' },
  { label: '装卸搬运和仓储业', value: '装卸搬运和仓储业' },
  { label: '邮政业', value: '邮政业' },
  ...
  { label: '互联网和相关服务', value: '互联网和相关服务' },
  { label: '软件和信息技术服务业', value: '软件和信息技术服务业' },
  { label: '金融业', value: '金融业' },
  { label: '货币金融服务', value: '货币金融服务' },
  { label: '资本市场服务', value: '资本市场服务' },
  { label: '保险业', value: '保险业' },
  { label: '其他金融业', value: '其他金融业' },
  { label: '房地产业', value: '房地产业' },
  { label: '房地产业', value: '房地产业' },
  { label: '租赁和商务服务业', value: '租赁和商务服务业' },
  { label: '租赁业', value: '租赁业' },
  { label: '商务服务业', value: '商务服务业' },
  { label: '科学研究和技术服务业', value: '科学研究和技术服务业' },
  { label: '研究和试验发展', value: '研究和试验发展' },
  { label: '专业技术服务业', value: '专业技术服务业' },
  { label: '科技推广和应用服务业', value: '科技推广和应用服务业' },
  { label: '水利、环境和公共设施管理业', value: '水利、环境和公共设施管理业' },
  { label: '水利管理业', value: '水利管理业' },
  { label: '生态保护和环境治理业', value: '生态保护和环境治理业' },
  { label: '公共设施管理业', value: '公共设施管理业' },
  { label: '居民服务、修理和其他服务业', value: '居民服务、修理和其他服务业' },
  { label: '居民服务业', value: '居民服务业' },
  {
    label: '机动车、电子产品和日用产品修理业',
    value: '机动车、电子产品和日用产品修理业',
  },
  { label: '其他服务业', value: '其他服务业' },
  { label: '教育', value: '教育' },
  { label: '教育', value: '教育' },
  ...
  { label: '新闻和出版业', value: '新闻和出版业' },
  {
    label: '广播、电视、电影和录音制作业',
    value: '广播、电视、电影和录音制作业',
  },
  { label: '文化艺术业', value: '文化艺术业' },
  { label: '体育', value: '体育' },
  { label: '娱乐业', value: '娱乐业' },
  {
  ...
  { label: '中国共产党机关', value: '中国共产党机关' },
  { label: '国家机构', value: '国家机构' },
  { label: '人民政协、民主党派', value: '人民政协、民主党派' },
  { label: '社会保障', value: '社会保障' },
  {
    label: '群众团体、社会团体和其他成员组织',
    value: '群众团体、社会团体和其他成员组织',
  },
  { label: '基层群众自治组织', value: '基层群众自治组织' },
