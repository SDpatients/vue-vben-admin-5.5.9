  ...
  <view class="detail-container" v-if="detail">
    <view class="header-card">
      ...
      <view class="header-info">
        <text class="name">{{ detail.shortName }}</text>
        <text class="level">{{ detail.courtLevel }}</text>
      </view>
    </view>

    <view class="section">
      <view class="section-title">法院信息</view>
      <view class="info-list">
        <view class="info-item">
          <text class="label">法院全称</text>
          <text class="value">{{ detail.fullName || '-' }}</text>
        </view>
        <view class="info-item" v-if="detail.undertakingJudge">
          <text class="label">承办法官</text>
          <text class="value">{{ detail.undertakingJudge }}</text>
        </view>
...
import { getCourtDetail, type CourtItem } from '@/api/basic-data'
